...
/**
 * Privacy tests for theme_solent2019.
 *
...
use \theme_solent2019\privacy\provider;

/**
 * Unit tests for theme_solent2019/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_solent2019_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_solent2019');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_solent2019'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_solent2019'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
