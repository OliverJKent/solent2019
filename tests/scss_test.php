...
/**
 * This file contains the unittests for solent2019's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_solent2019_scss_testcase extends advanced_testcase {
    /**
     * Test that solent2019 can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('solent2019')->get_css_content_debug('scss', null, null)
        );
    }
}
